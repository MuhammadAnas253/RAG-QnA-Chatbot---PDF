...
load_dotenv()
os.environ["GROQ_API_KEY"] = os.getenv('GROQ_API_KEY') or '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'

# Step 1 for loading the data 

pdf_path = "Constitution of pakistan-unlocked.pdf"  
